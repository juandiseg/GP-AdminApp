...
public class mainShifts {
    ...
    public mainShifts(JPanel panel3, String from, String to, boolean shiftDate) {
        this.from = from;
        this.to = to;
        ...
        panel3Layout.setVerticalGroup(
                panel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(GroupLayout.Alignment.TRAILING, panel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addGroup(
                                        panel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
            ...
            public void mouseClicked(MouseEvent me) {
                if (me.getClickCount() == 2) {
                    try {
                        ...
                        try {
                            panel3.removeAll();
                            new editShifts(panel3, from, to, shiftDate,
    ...
    private void applyButton(JPanel panel3) {
    ...
    private void addButton(JPanel panel3) {
        class addMethodHolder extends iNavigatorButton {
            public void createNewNavigator() {
                new addShifts(panel3, from, to, shiftDate);
            }
        }
        navigatorButtonFormatter.formatNavigationButton(addShiftButton, new addMethodHolder(), panel3, false,
                "Add Shifts");
    }
