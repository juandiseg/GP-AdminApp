...
public class check_sWindow extends abstractAddWindow {
    ...
    public check_sWindow(abstractUpdater previousWindow) {
        ...
        getAddButton().addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (chooseButton.getText().equals("Employees"))
                    shift_date = false;
                if (true /* ¡CHECK INPUT! */ ) {
                    assist_check_sWindow tempWdw = new assist_check_sWindow(temp, from, to, shift_date);
