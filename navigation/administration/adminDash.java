...
public class adminDash {
        ...
        public adminDash(JFrame theFrame, JPanel leftAuxPanel, JPanel panel3, JPanel jPanel4,
                        JLabel date) {
                initPanel2(leftAuxPanel, jPanel4, date);
                initPanel3(panel3);
                addListeners(panel3, theFrame);
        }
        ...
        private void addListeners(JPanel panel3, JFrame theFrame) {
                ...
                shiftsPanel.addMouseListener(new MouseListener() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                                ...
                                clicked = true;
                                panel3.removeAll();
                                new mainShifts(panel3, "01-06-2022", "01-06-2023", false);
                                panel3.revalidate();
                                panel3.repaint();
                        }
                ...
                reportsPanel.addMouseListener(new MouseListener() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                                ...
                                clicked = true;
                                panel3.removeAll();
                                new mainReports(theFrame, panel3);
                                panel3.revalidate();
                                panel3.repaint();
                        }
