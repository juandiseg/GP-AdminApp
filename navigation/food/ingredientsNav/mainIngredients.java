...
public class mainIngredients {
    ...
    public mainIngredients(JPanel panel3) {
        initPanel3(panel3);
        populateTable();
        addListeners(panel3);
    }
    ...
    private void addButton(JPanel panel3) {
        class addMethodHolder extends iNavigatorButton {
            public void createNewNavigator() {
                new addIngredient(panel3);
            }
        }
        navigatorButtonFormatter.formatNavigationButton(addIngredientButton, new addMethodHolder(), panel3, false,
                "Add Ingredient");
    }
