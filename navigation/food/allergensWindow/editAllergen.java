                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(117, 117, 117)
                                                .addComponent(nameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 106,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(nameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(49, 49, 49)
                                .addComponent(editAllergenButton, javax.swing.GroupLayout.PREFERRED_SIZE, 55,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(playgroundLayout
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, playgroundLayout
                                                ...
                                                .addComponent(deleteButton, javax.swing.GroupLayout.PREFERRED_SIZE, 200,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addComponent(editAllergenLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(auxEditAllergenLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap()));
    ...
    private void addActionListeners(JPanel playground) {
        ...
        editAllergenButton.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (name.isEmpty()) {
                    successLabel.setText("You must assign a new name in order to edit an allergen.");
                    successLabel.setVisible(true);
                    return;
                }
                if (new allergensAPI().editAllergen(theCurrentAllergen, name)) {
                    ...
                    successLabel.setText("Something went wrong while updating " + theCurrentAllergen.getName());
                    successLabel.setVisible(true);
                }
            }
        ...
        deleteButton.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                int reply = JOptionPane.showConfirmDialog(null,
                        "Are you sure you want to delete " + theCurrentAllergen.getName() + " from allergens?",
                        "Confirmation", JOptionPane.YES_NO_OPTION);
                if (reply == JOptionPane.YES_OPTION) {
                    if (!new allergensAPI().removeAllergen(theCurrentAllergen)) {
                        JOptionPane.showMessageDialog(playground, "Something went wrong.", "Error",
