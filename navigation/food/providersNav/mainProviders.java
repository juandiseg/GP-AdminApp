...
public class mainProviders {
    ...
    public mainProviders(JPanel panel3) {
        initPanel3(panel3);
        populateTable();
        addListeners(panel3);
    }
            ...
            public void mouseClicked(MouseEvent me) {
                if (me.getClickCount() == 2) {
                    try {
                        ...
                        panel3.removeAll();
                        new editProvider(panel3, new provider(ID, name, email));
                        panel3.revalidate();
                        panel3.repaint();
    ...
    private void addButton(JPanel panel3) {
        class addMethodHolder extends iNavigatorButton {
            public void createNewNavigator() {
                new addProvider(panel3);
            }
        }
        navigatorButtonFormatter.formatNavigationButton(addProviderButton, new addMethodHolder(), panel3, false,
                "Add Provider");
    }
