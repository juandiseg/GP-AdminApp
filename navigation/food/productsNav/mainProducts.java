...
public class mainProducts {
    ...
    public mainProducts(JPanel panel3) {
        initPanel3(panel3);
        populateTable();
        addListeners(panel3);
    }
            ...
            public void mouseClicked(MouseEvent me) {
                if (me.getClickCount() == 2) {
                    try {
                        ...
                        panel3.removeAll();
                        new editProduct(panel3, new product(ID, catID, date, name, price, true));
                        panel3.repaint();
                        panel3.revalidate();
    ...
    private void addButton(JPanel panel3) {
        class addMethodHolder extends iNavigatorButton {
            public void createNewNavigator() {
                new addProduct(panel3);
            }
        }
        navigatorButtonFormatter.formatNavigationButton(addProductButton, new addMethodHolder(), panel3, false,
                "Add Product");
    }
